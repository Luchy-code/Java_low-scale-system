...
public class ViajeFeliz implements IViajeFeliz {
	...
	public String toString() {
		...
		for(ClienteContratacion cc:this.contrataciones.values()) {
	        sb.append(cc.devolverDNI()).append("\n");
	        for(Paquete paq:cc.listaContratacionesCopia()) {
					sb.append("Codigo paquete: ").append(paq.obtenerCodigo()).append("\n");
					for(ServicioSimple ss:paq.listaServiciosCopia()) {
						sb.append("Codigo servicio: ").append(ss.obtenerCodUnico()+" ").append(ss.DatosAPagar()).append("\n");
					}
				}
			//sb.append(cc.totalApagarContratacion()).append("\n");
			sb.append("\n");
		}
		return sb.toString()+" ViajeFeliz [cuit=" + cuit + "]";
	}
