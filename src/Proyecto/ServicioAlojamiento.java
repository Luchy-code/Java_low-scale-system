...
public class ServicioAlojamiento extends ServicioSimple {
	...
	protected String DatosAPagar() {
		return "Tipo: "+super.obtenerNombreServicio()+" costo:"+super.obtenerCostoBase()+" cantPersonas:"+super.obtenerCantPersonas()+" cantDias: "+this.cantDias+" costoTranslado: "+costoTraslado+" tot="+this.totalApagar();
		}
