...
public class ServicioExcursion extends ServicioSimple {
	...
	protected String DatosAPagar() {
		return "Tipo: "+super.obtenerNombreServicio()+" costo:"+super.obtenerCostoBase()+" cantPeronas:"+super.obtenerCantPersonas()+" costoTrnas: "+" "+this.diaCompleto+" "+descuento+" ="+this.totalApagar();
	}
